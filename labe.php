        ...
        <div class="container-fluid con-fluid1" data-aos="fade-up">
            <div class="row no-gutters card-shadow pr-3" data-aos="fade-up" data-aos-delay="100">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                            <center><h4 class="underline-small">ABOUT</h4></center>
                            <!--<hr>-->
                            <p class="description pt-3" align="justify" >
                            For the availability of quality drugs and food to the people
...
the food or drugs which are declared substandard.<br><br>
...
in Maharashtra State is 7-12%.<br><br>

From the above figures it is evident that, he quality of
drugs manufactured in Maharashtra is of good quality than
any other state.<br><br>
                            
                            It is expected that, not of standard quality drugs should to
...
Laboratories are as per Drug Table No. 6.<br><br>

                            To increase the capacity of analysis of food and drugs
